export const AUTH_COOKIE = 'dental_orthodontic_operations_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@dental-orthodontic-operations.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@dental-orthodontic-operations.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@dental-orthodontic-operations.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
