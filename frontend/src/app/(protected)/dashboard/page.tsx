...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Dental Orthodontic Operations Dashboard"
      subtitle="One merged dental orthodontic operations view for Patients, Appointments, Cases, Care Plans, Authorizations, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared dental orthodontic operations jobs into one surface. Patients, Appointments, Cases, Care Plans, Authorizations, Resources, documents, audit, and AI are presented as platform features.</div>
