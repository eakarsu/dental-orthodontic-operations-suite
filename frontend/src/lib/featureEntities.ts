...
const entitySeeds = [
  ...
  ["lab-case-intake","Lab Case Intake Records","Lab Case Intake operating queue","Open","Lab Case Intake follow-up list","Dental Lab Case","$0"],
  ["appliance-tracking","Appliance Tracking Records","Appliance Tracking operating queue","Review","Appliance Tracking follow-up list","Dental Lab Case","$0"],
  ["case-quality-review","Case Quality Review Records","Case Quality Review operating queue","Review","Case Quality Review follow-up list","Dental Lab Case","$0"],
  ["shade-material-review","Shade & Material Review Records","Shade & Material Review operating queue","Open","Shade & Material Review follow-up list","Dental Lab Deep Workflows","$0"],
  ["scan-file-intake","Scan File Intake Records","Scan File Intake operating queue","Review","Scan File Intake follow-up list","Dental Lab Deep Workflows","$0"],
  ["remake-risk-review","Remake Risk Review Records","Remake Risk Review operating queue","Review","Remake Risk Review follow-up list","Dental Lab Deep Workflows","$0"],
  ["clinician-lab-messages","Clinician Lab Messages Records","Clinician Lab Messages operating queue","Review","Clinician Lab Messages follow-up list","Dental Lab Deep Workflows","$0"],
